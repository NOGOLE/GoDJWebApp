	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Song']))
		{
			$model->attributes=$_POST['Song'];
                        $model->song_id = rand(0,19000);
                        
                         $model->song = CUploadedFile::getInstance($model,'path');
                        $filename = $model->title.$model->artist.".mp3";
                        //$model->path = $filename;
                        //var_dump($model);
                        //exit();
			if($model->save())
                        {
                                ...
                                //$song_path = realpath(Yii::app()->basePath . '/../songs');
                                //$model->song->saveAs($song_path . '/' . $model->song);
